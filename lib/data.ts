...
export const safetyCopy = [
  ...
  "체외충격파 치료는 도수치료와 다른 치료군으로, 통증 부위와 기존 치료 반응을 확인해 필요한 경우 상담합니다.",
  "가입 보험의 보장 여부와 금액은 상품과 보험사 기준에 따라 달라질 수 있으며, 병원이 단정하지 않습니다."
];
...
export const programPages: Record<ProgramSlug, ProgramPageData> = {
    ...
    detailSections: [
      {
        ...
        items: ["통증·저림 위치 확인", "보행거리와 균형 상태 확인", "보호자 동행 상담 가능"]
      },
      {
        title: "준비하면 좋은 자료",
  ...
  "manual-exercise-rehab": {
    ...
    detailSections: [
      {
        title: "도수치료와 운동재활 구분",
        description: "도수치료는 통증 부위와 움직임 제한을 확인해 필요한 경우 상담하며, 운동재활은 보행, 근력, 균형, 관절 운동범위, 일상 동작을 함께 살펴보는 회복관리 과정입니다.",
        items: ["도수치료 단독 판매형 표현 지양", "운동재활은 기능 회복 중심", "모든 환자에게 동일 적용하지 않음"]
      },
      {
        title: "정책·관리기준 안내",
      ...
      {
        title: "체외충격파와 별도 안내",
        description: "체외충격파 치료는 도수치료와 다른 치료군입니다. 통증 부위, 손상 양상, 기존 치료 반응을 확인한 뒤 필요한 경우 별도로 상담할 수 있습니다.",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "도수치료는 모든 환자에게 동일하게 적용되는 치료가 아닙니다. 환자 상태, 증상, 진찰 소견, 기존 치료 반응을 함께 확인한 뒤 필요한 경우 상담할 수 있습니다."
  },
  {
  ...
  },
  {
    ...
    answer:
      "가입 보험의 보장 여부와 금액은 상품과 보험사 기준에 따라 달라질 수 있으며 병원이 단정하지 않습니다. 진료 후 필요한 치료 단계와 관련 서류 안내를 확인할 수 있습니다."
  },
  {
    question: "체외충격파와 도수치료는 같은 치료인가요?",
    answer:
      "아닙니다. 체외충격파 치료는 도수치료와 다른 치료군입니다. 통증 부위, 손상 양상, 기존 치료 반응을 확인한 뒤 필요한 경우 별도로 상담합니다."
  },
  {
    question: "수술 후 회복이 늦으면 재활 상담이 필요한가요?",
    answer:
      "수술 후 통증, 저림, 보행 불안, 운동범위 제한이 지속되면 수술 범위, 기존 영상자료, 현재 기능 상태를 함께 확인해 회복관리 방향을 상담할 수 있습니다."
  },
  {
  ...
  },
  {
    ...
    answer:
      "보호자 동행은 증상 변화, 보행거리, 낙상 경험, 복용약, 일상생활 제한을 함께 설명하는 데 도움이 될 수 있습니다. 치료 방향은 진료 후 상담합니다."
  },
  {
    question: "산후·육아 통증도 상담할 수 있나요?",
    answer:
      "아기 안기, 수유 자세, 반복되는 손목·허리·골반·목어깨 통증은 생활 동작과 근골격계 부담을 함께 확인해 상담할 수 있습니다."
  },
  {
