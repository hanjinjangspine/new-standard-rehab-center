...
export default function MobileBottomCTA() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-3 border-t border-line bg-white/96 shadow-2xl backdrop-blur md:hidden">
      ...
      <Link href="/manual-exercise-rehab" className="flex flex-col items-center justify-center gap-1 border-x border-line py-2 text-xs font-extrabold text-brand-700">
